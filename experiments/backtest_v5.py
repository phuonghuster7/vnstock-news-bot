"""
Phase 4: Backtest với VN Market Constraints cho mô hình V5 (có fundamental)
"""
import os
import yaml
import pandas as pd
...
def main():
    print("=" * 60)
    print("PHASE 4 — BACKTEST VN30 WITH V5 PREDICTIONS (FUNDAMENTAL)")
    print("=" * 60)

    qlib.init(provider_uri=QLIB_DIR)

    pred_path = os.path.join(os.path.dirname(__file__), "..", "results", "v5", "pred.pkl")
